...
SELECT o.ono, c.cname, i.item_name, o.ordered_quantity, o.odate FROM customer c JOIN orders o USING (cno) JOIN items i USING (item_no) WHERE c.cname = 'Mr Patil';

-- Find a Warehouse which has maximum stores
SELECT MAX(y.store_count) AS num_stores, y.warehouse, y.wname FROM (SELECT COUNT(s.store_name) store_count, s.warehouse, w.wname
	FROM stores s
